...
<body class="dark-theme">
    <header>
        <header class="header-left">
            <a class="logo_header" href="http://localhost:9000/index.php">StormCrown</a>
            <a class="game_header" href="http://localhost:9000/index.php">Игра</a>
            <a class="edu_header" href="http://localhost:8080/education.html">Обучение</a>
        ...
        <header class="header-right">
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a class="fon">Фон</a>
                    <a class="style-figures">Оформление фигур</a>
                    <a class="style-board">Оформление доски</a>
                </div>
              </div>
            <a class="login_href">Войти</a>
        </header>
    </header>